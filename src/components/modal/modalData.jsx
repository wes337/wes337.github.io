...
const modalData = {
  aStar: {
    ...
    details: (
      <>
        A visual way to see how the{" "}
        <a
          href="https://en.wikipedia.org/wiki/A*_search_algorithm"
          target="_blank"
          rel="noopener noreferrer"
        >
          A* search algorithm works
        </a>{" "}
        in pathfinding.
        <br />
        <br />
        Click to set a start and ending position, then you can draw unpassable
        nodes/walls. The algorithm will find the shortest path!
      </>
    ),
  ...
  personalTraining: {
    ...
    details: (
      <>
        A Bootsrapped React app of a Personal Training Company. I created this
        for my Front-End Development course at University. You can manage
        customers and their schedules for their trainings at the gym.
        <br />
        <br />
        I&apos;ve deployed this app{" "}
        <a
          href="https://personaltrainingapp-9023e.firebaseapp.com/"
          target="_blank"
          rel="noopener noreferrer"
        >
          here
        ...
        <br />
        <br />
        <em>You can sign up, or login using these test credentials:</em>
  ...
  bugTracking: {
    ...
    details: (
      <>
        A project manager app for iOS &amp; Android. Create tasks for your
        projects, organize them using custom categories, and track their
        progress with project milestones.
        <br />
        <br />
        Built using{" "}
        <a href="https://www.expo.io" target="_blank" rel="noopener noreferrer">
          Expo
        </a>{" "}
        and styled with{" "}
        <a
  ...
  mobilePlaces: {
    ...
    details: (
      <>
        A React Native app used to track your favourite places. Built with{" "}
        <a href="https://www.expo.io" target="_blank" rel="noopener noreferrer">
          Expo
        </a>
        ,{" "}
        <a
          href="https://github.com/react-native-community/react-native-maps"
          target="_blank"
          rel="noopener noreferrer"
        >
          react-native-maps
        ...
        and{" "}
        <a
          href="https://react-native-elements.github.io/react-native-elements/"
          target="_blank"
          rel="noopener noreferrer"
        >
          react-native-elements
        </a>
        . Real-time database provided by Google FireBase.
      </>
    ),
  ...
  hwTracker: {
    ...
    details: (
      <>
        A homework tracking application built with Java Spring. Can be used to
        keep track of assignments, projects, and other deadlines. <br />
        <br />A live version of this app has been deployed on Heroku, you can
        see it{" "}
        <a
          href="https://serverprog-homeworktracker.herokuapp.com/"
          target="_blank"
          rel="noopener noreferrer"
        >
          here
  ...
  bookStore: {
    ...
    details: (
      <>
        A book store app created for my Server Programming course at university.
        Created using an MVC design and implementing basic CRUD functions.
        <br />
        <br />A live version of this app has been deployed on Heroku, you can
        see it{" "}
        <a
          href="https://serverprogramming-bookstore.herokuapp.com/login"
          target="_blank"
          rel="noopener noreferrer"
        >
          here
        ...
        .<br />
        <br />
        <em>You can signup, or login using the following test account:</em>
